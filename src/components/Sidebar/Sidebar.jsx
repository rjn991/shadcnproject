...
const Sidebar = () => {
  return (
    <div className="w-60 text-gray-500">
      <img className="w-28 m-2 mt-5" src={logo} alt="logo"></img>
      
      <div className=" font-bold">
        <div className="flex m-3 px-2 py-3 rounded-md cursor-default hover:bg-zinc-100">
          <img src={dashboardIcon} alt="sidebar-icon"></img>
          <p className="ml-2">Dashboard</p>
        </div>
        <div className="flex m-3 px-2 py-3 cursor-default text-black bg-zinc-100 rounded-md">
